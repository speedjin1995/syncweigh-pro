                                                    ...
                                                    <div class="card-header">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <div class="flex-shrink-0">
                                                                <?php if(hasModulePermission('Master Data', 'Plant', ['download_template'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Plant', ['export_excel'])): ?>
            ...
            { 
                ...
                render: function ( data, type, row ) {
                    ...
                    if (row.status == 'Inactive') {
                        if (isSADMIN || (permissions['Master Data'] && permissions['Master Data']['Plant'] && permissions['Master Data']['Plant'].includes('reactivate'))){
                            buttons += `
                        ...
                        if (isSADMIN || (permissions['Master Data'] && permissions['Master Data']['Plant'] && ['edit', 'delete'].some(p => permissions['Master Data']['Plant'].includes(p)))) {
                            buttons += `
                                <div class="dropdown d-inline-block">
                                    ...
                                    if (isSADMIN || (permissions['Master Data'] && permissions['Master Data']['Plant'] && permissions['Master Data']['Plant'].includes('edit'))){
                                        buttons += `
                                            <li>
