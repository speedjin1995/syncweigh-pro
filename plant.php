...
<?php
    if (!hasModulePermission('Master Data', 'Plant', ['view', 'create', 'edit'])){
        header('Location: no-permission.php');
        exit;
    }
?>
<head>
    <title>Plants | PWS - Weighing System</title>
                                        ...
                                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalScrollableTitle">Add New Plant</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <form role="form" id="plantForm" class="needs-validation" novalidate autocomplete="off">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="row">
                                                                            <div class="col-xxl-12 col-lg-12 mb-3">
                                                                                <div class="row">
                                                                                    <label for="plantCode" class="col-sm-4 col-form-label">Plant Code</label>
                                                                                    <div class="col-sm-8">
                                                                            ...
                                                                            <div class="col-xxl-12 col-lg-12 mb-3">
                                                                                <div class="row">
                                                                                    <label for="plantName" class="col-sm-4 col-form-label">Plant Name</label>
                                                                                    <div class="col-sm-8">
                                                                                        <input type="text" class="form-control" id="plantName" name="plantName" placeholder="Plant Name" required>
                                                                                        <div class="invalid-feedback">
                                                                                            Please fill in the field.
                                                                                        </div>
                                                                                    </div>
                                            ...
                                            <div class="modal-content">
                                                <form role="form" id="uploadForm">
                                                    ...
                                                    <div class="modal-footer justify-content-between bg-gray-dark color-palette">
                                                        ...
                                                        <button type="button" class="btn btn-danger" id="uploadPlant">Save changes</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <div class="flex-shrink-0">
                                                                <?php if(hasModulePermission('Master Data', 'Plant', ['upload_excel'])): ?>
                                                                <a href="template/Plant_Template.xlsx" download>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Plant', ['export'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Plant', ['create'])): ?>
                                                    ...
                                                    <div class="card-body">
                                                        <table id="plantTable" class="table table-bordered nowrap table-striped align-middle" style="width:100%">
                                                            <thead>
                                                                <tr>
...
$(function () {
            ...
            { 
                ...
                render: function ( data, type, row ) {
                    ...
                    if (row.status == 'Inactive') {
                        if (permissions['Master Data'] && permissions['Master Data']['Plant'] && permissions['Master Data']['Plant'].includes('reactivate')){
                            buttons += `
                        ...
                        if (permissions['Master Data'] && permissions['Master Data']['Plant'] && ['edit', 'delete'].some(p => permissions['Master Data']['Plant'].includes(p))) {
                            buttons += `
                                <div class="dropdown d-inline-block">
                                    <button class="btn btn-soft-secondary btn-sm dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="ri-more-fill align-middle"></i>
                                    ...
                                    if (permissions['Master Data'] && permissions['Master Data']['Plant'] && permissions['Master Data']['Plant'].includes('edit')){
                                        buttons += `
                                            <li>
                                    ...
                                    if (permissions['Master Data'] && permissions['Master Data']['Plant'] && permissions['Master Data']['Plant'].includes('delete')){
                                        buttons += `
                                            <li>
    ...
    $('#exportExcel').on('click', function(){
        window.open("php/exportMasterData.php?selectedValue=Plant");
    });
    ...
    $('#multiDeactivate').on('click', function () {
        ...
        $("#plantTable tbody input[type='checkbox']").each(function () {
            if (this.checked) {
        ...
        if (selectedIds.length > 0) {
            ...
            alert("Please select at least one plant to delete.");
            $('#spinnerLoading').hide();
        }     
    });
});
