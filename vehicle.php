                                            ...
                                            <div class="modal-content">
                                                <form role="form" id="uploadForm">
                                                    ...
                                                    <div class="modal-footer justify-content-between bg-gray-dark color-palette">
                                                        ...
                                                        <button type="button" class="btn btn-danger" id="uploadVehicle">Save changes</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
...
$(function () {
            ...
            { 
                ...
                render: function ( data, type, row ) {
                    ...
                    if (row.status == 'Inactive') {
                        if (permissions['Master Data'] && permissions['Master Data']['Vehicle'] && permissions['Master Data']['Vehicle'].includes('reactivate')){
                            buttons += `
                        ...
                        if (permissions['Master Data'] && permissions['Master Data']['Vehicle'] && ['edit', 'delete'].some(p => permissions['Master Data']['Vehicle'].includes(p))) {
                            buttons += `
                                <div class="dropdown d-inline-block">
                                    <button class="btn btn-soft-secondary btn-sm dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="ri-more-fill align-middle"></i>
                                    ...
                                    if (permissions['Master Data'] && permissions['Master Data']['Vehicle'] && permissions['Master Data']['Vehicle'].includes('edit')){
                                        buttons += `
                                            <li>
                                    ...
                                    if (permissions['Master Data'] && permissions['Master Data']['Vehicle'] && permissions['Master Data']['Vehicle'].includes('delete')){
                                        buttons += `
                                            <li>
    ...
    $('#exportExcel').on('click', function(){
        window.open("php/exportMasterData.php?selectedValue=Vehicle");
    });
