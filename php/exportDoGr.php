        ...
        if($do_stmt->num_rows > 0){  
            ...
            while($row = $do_stmt->fetch_assoc()){
                ...
                while($row2 = mysqli_fetch_assoc($doRecords)) {
                    ...
                    $lineData = array($poNo, $row2['transaction_id'], $tareDateTime, $row2['lorry_plate_no1'], $row2['supplier_code'], $row2['supplier_name'], $row2['raw_mat_code'], $row2['raw_mat_name'], $row2['destination'], $row2['transporter_code'], $exDel, $orderNo, $row2['delivery_no'], $qty, $uom, $row2['plant_code'], $row2['plant_code'], $unitPrice, $amt);
