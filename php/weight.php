...
, $_POST['manualWeight'], $_POST['plantCode'], $_POST['plant'], $_POST['exDel'], $_POST['loadDrum'])) {
    ...
    if (empty($_POST["supplierWeightBasicUom"])) {
        $supplierWeightUom = null;
    } else {
        $supplierWeightUom = trim($_POST["supplierWeightBasicUom"]);
    }
    ...
    if (empty($_POST["orderWeightBasicUom"])) {
        $orderWeightUom = null;
    } else {
        $orderWeightUom = trim($_POST["orderWeightBasicUom"]);
    }
