        ...
        if (! $update_stmt->execute()) {
            ...
            while ($row = $result->fetch_assoc()) {
                if ($format == 'EXPANDABLE'){
                    ...
                    $message['gross_weight1'] = $row['gross_weight1'] ?? 0;
                    $message['gross_weight1_date'] = $row['gross_weight1_date'] ?? '';
                    $message['tare_weight1'] = $row['tare_weight1'] ?? 0;
                    $message['tare_weight1_date'] = $row['tare_weight1_date'] ?? '';
                    $message['nett_weight1'] = $row['nett_weight1'] ?? 0;
                    $message['gross_weight2'] = $row['gross_weight2'] ?? 0;
                    $message['gross_weight2_date'] = $row['gross_weight2_date'] ?? '';
                    $message['tare_weight2'] = $row['tare_weight2'] ?? 0;
                    $message['tare_weight2_date'] = $row['tare_weight2_date'] ?? '';
                    $message['nett_weight2'] = $row['nett_weight2'] ?? 0;
                    $message['reduce_weight'] = $row['reduce_weight'] ?? 0;
                    $message['final_weight'] = $row['final_weight'];
                    $message['weight_different'] = $row['weight_different'] ?? 0;
                    ...
                    $message['sub_total'] = $row['sub_total'] ?? 0;
                    $message['sst'] = $row['sst'] ?? 0;
