...
if($_SESSION["roles"] == 'ADMIN'){
    ...
    $empQuery = "select * from Weight where status = '0' and is_cancel <> 'Y' and created_by='$username'".$searchQuery." order by ".$columnName." ".$columnSortOrder." limit ".$row.",".$rowperpage;
}
