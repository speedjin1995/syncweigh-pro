...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_err) && empty($password_err)) {
        ...
        $sql = "SELECT id, employee_code, username, password, role, plant_id, allow_manual FROM Users WHERE username = ?";
        ...
        if ($stmt = mysqli_prepare($link, $sql)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                if (mysqli_stmt_num_rows($stmt) == 1) {
                    ...
                    mysqli_stmt_bind_result($stmt, $id, $code, $username, $hashed_password, $roles, $plant, $allow_manual);
                            ...
                            <div class="text-center mt-sm-5 mb-4 text-white-50">
                                <div>
                                    <a href="index.php" class="d-inline-block auth-logo">
                                        <img src="assets/images/logo-lg.png" alt="assets/images/logo-lg-bk.png" height="150">
                                    </a>
                                </div>
