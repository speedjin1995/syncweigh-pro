...
<div id="layout-wrapper">
    ...
    $(function () {
        ...
        table = $("#weightTable").DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url':'php/filterCancelledWeight.php',
                'data': {
                    fromDate: fromDateI,
                    toDate: toDateI,
                    status: statusI,
        ...
        $('#exportExcel').on('click', function(){
            ...
            if (selectedIds.length > 0){
                window.open("php/export.php?file=weight&isMulti=Y&type=Weighing&weightStatus=Cancelled&fromDate="+fromDateI+"&toDate="+toDateI+
                ...
                window.open("php/export.php?file=weight&isMulti=N&type=Weighing&weightStatus=Cancelled&fromDate="+fromDateI+"&toDate="+toDateI+
                "&status="+statusI+"&customer="+customerNoI+"&vehicle="+vehicleNoI+
        ...
        $('#multiDeactivate').on('click', function () {
            ...
            if (selectedIds.length > 0) {
                if (confirm('Are you sure you want to delete this item?')) {
                    $.post('php/deleteWeight.php', {userID: selectedIds, type: 'MULTI', action: 'Delete'}, function(data){
                        var obj = JSON.parse(data);
