                                                                        ...
                                                                        <div class="row mb-3">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <div class="input-group-text">Kg</div>
                                                                                    <button class="input-group-text btn btn-primary fs-5" style="background-color: #008001;" id="grossCapture" type="button"><i class="mdi mdi-sync"></i></button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row mb-3">
                                                                            ...
                                                                            <div class="col-sm-8">                                                                                     
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <div class="input-group-text">Kg</div>
                                                                                    <button class="input-group-text btn btn-primary fs-5" style="background-color: #008001;" id="tareCapture" type="button"><i class="mdi mdi-sync"></i></button>
                                                                                </div>                                                                                       
                                                                            </div>
                                                                        </div>
                                                                        <div class="row mb-3">
                                                                        ...
                                                                        <div class="row mb-3">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <div class="input-group-text">Kg</div>
                                                                                    <button class="input-group-text btn btn-primary fs-5" style="background-color: #008001;" id="grossCapture2"><i class="mdi mdi-sync" type="button"></i></button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row mb-3">
                                                                        ...
                                                                        <div class="row mb-3">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <div class="input-group-text">Kg</div>
                                                                                    <button class="input-group-text btn btn-primary fs-5" style="background-color: #008001;" id="tareCapture2" type="button"><i class="mdi mdi-sync"></i></button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row mb-3">
                                                ...
                                                <form role="form" id="bypassForm" class="needs-validation" novalidate autocomplete="off">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="hstack gap-2 justify-content-end">
                                                                <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                                                                <button type="button" class="btn btn-primary" style="background-color: #008001;" id="submitBypass">Submit</button>
                                                            </div>
                                                        </div><!--end col-->   
                                                    </div>
                                                </form>
                                                ...
                                                <form role="form" id="approvalForm" class="needs-validation" novalidate autocomplete="off">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="hstack gap-2 justify-content-end">
                                                                <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                                                                <button type="button" class="btn btn-primary" style="background-color: #008001;" id="submitApproval">Submit</button>
                                                            </div>
                                                        </div><!--end col-->   
                                                    </div>
                                                </form>
                                                    ...
                                                    <div class="card-header">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <div class="flex-shrink-0">
                                                                <button type="button" id="addWeight" class="btn btn-primary waves-effect waves-light" style="background-color: #008001;" data-bs-toggle="modal" data-bs-target="#addModal">
                ...
                <div class="modal-dialog modal-xl">
                    ...
                    <form role="form" id="setupForm">
                        ...
                        <div class="modal-footer justify-content-between bg-gray-dark color-palette">
                            ...
                            <button type="submit" class="btn btn-primary" style="background-color: #008001;">Save</button>
                        </div>
                    </form>
                </div>
            </div>
