                                                    ...
                                                    <div class="card-header">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <div class="flex-shrink-0">
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Customer', ['export_excel'])): ?>
...
$(function () {
            ...
            { 
                ...
                render: function ( data, type, row ) {
                    ...
                    if (row.status == 'Inactive') {
                        if (isSADMIN || (permissions['Master Data'] && permissions['Master Data']['Customer'] && permissions['Master Data']['Customer'].includes('reactivate'))){
                            buttons += `
                        ...
                        if (isSADMIN || (permissions['Master Data'] && permissions['Master Data']['Customer'] && ['edit', 'delete'].some(p => permissions['Master Data']['Customer'].includes(p)))) {
                            buttons += `
                                <div class="dropdown d-inline-block">
                                    <button class="btn btn-soft-secondary btn-sm dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="ri-more-fill align-middle"></i>
                                    ...
                                    if (isSADMIN || (permissions['Master Data'] && permissions['Master Data']['Customer'] && permissions['Master Data']['Customer'].includes('delete'))){
                                        buttons += `
                                            <li>
    ...
    $('#exportExcel').on('click', function(){
        window.open("php/exportMasterData.php?selectedValue=Customer");
    });
