...
if (!hasModulePermission('Report', 'Sales', ['view'])){
...
if (hasModulePermission('Report', 'Sales', ['view_all_plants'])){
...
<head>
    ...
    <title>Sales Reports | PWS - Weighing System</title>
                                                    ...
                                                    <div class="col-3">
                                                        <div class="mb-3">
                                                            ...
                                                            <select id="plantSearch" class="form-select select2">
                                                                <?php if (hasModulePermission('Report', 'Sales', ['view_all_plants'])){ ?>
                                                                <option selected>-</option>
                                                                <?php } ?>
                                                    ...
                                                    <div class="card-header">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <div class="flex-shrink-0">                                            
                                                                <?php if (hasModulePermission('Report', 'Sales', ['export_summary_report'])){ ?>
                                                                ...
                                                                <?php if (hasModulePermission('Report', 'Sales', ['export_sales_report'])){ ?>
                                                                ...
                                                                <?php if (hasModulePermission('Report', 'Sales', ['export_excel'])){ ?>
