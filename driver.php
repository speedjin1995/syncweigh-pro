                                        ...
                                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalScrollableTitle">Add New Driver</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <form role="form" id="driverForm" class="needs-validation" novalidate autocomplete="off">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="row">
                                                                            <div class="col-xxl-12 col-lg-12 mb-3">
                                                                                <div class="row">
                                                                                    <label for="driverCode" class="col-sm-4 col-form-label">Driver Code</label>
                                                                                    <div class="col-sm-8">
                                                                                        <input type="text" class="form-control" id="driverCode" name="driverCode" placeholder="Driver Code" required>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        <table id="driverTable" class="table table-bordered nowrap table-striped align-middle" style="width:100%">
                                                            <thead>
                                                                <tr>
                                                                    <th>Driver Code</th>
                                                                    <th>Driver Name</th>
