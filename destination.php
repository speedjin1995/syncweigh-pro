...
<?php
    if (!hasModulePermission('Master Data', 'Destination', ['view', 'create', 'edit'])){
        header('Location: no-permission.php');
        exit;
    }
?>
<head>
    <title>Destination | PWS - Weighing System</title>
                                            ...
                                            <div class="modal-content">
                                                <form role="form" id="uploadForm">
                                                    ...
                                                    <div class="modal-footer justify-content-between bg-gray-dark color-palette">
                                                        ...
                                                        <button type="button" class="btn btn-danger" id="uploadDestination">Save changes</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="card-header">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <div class="flex-shrink-0">
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Destination', ['upload_excel'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Destination', ['export_excel'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Destination', ['create'])): ?>
...
$(function () {
    ...
    $('#exportExcel').on('click', function(){
        window.open("php/exportMasterData.php?selectedValue=Destination");
    });
