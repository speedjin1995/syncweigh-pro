            ...
            { 
                ...
                render: function ( data, type, row ) {
                    ...
                    if (row.status == 'Inactive') {
                        if (permissions['Master Data'] && permissions['Master Data']['Raw Material'] && permissions['Master Data']['Raw Material'].includes('reactivate')){
                            buttons += `
                        ...
                        if (permissions['Master Data'] && permissions['Master Data']['Raw Material'] && ['edit', 'delete'].some(p => permissions['Master Data']['Raw Material'].includes(p))) {
                            buttons += `
                                <div class="dropdown d-inline-block">
                                    <button class="btn btn-soft-secondary btn-sm dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="ri-more-fill align-middle"></i>
                                    ...
                                    if (permissions['Master Data'] && permissions['Master Data']['Raw Material'] && permissions['Master Data']['Raw Material'].includes('edit')){
                                        buttons += `
                                            <li>
                                    ...
                                    if (permissions['Master Data'] && permissions['Master Data']['Raw Material'] && permissions['Master Data']['Raw Material'].includes('delete')){
                                        buttons += `
                                            <li>
