...
<?php
    if (!hasModulePermission('Master Data', 'Sales Representative', ['view', 'create', 'edit'])){
...
<head>
    <title>SRP | PWS - Weighing System</title>
                                                    ...
                                                    <div class="card-header">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <div class="flex-shrink-0">
                                                                <?php if(hasModulePermission('Master Data', 'Sales Representative', ['download_template'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Sales Representative', ['upload_excel'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Sales Representative', ['export_excel'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Sales Representative', ['pull_from_sql'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Sales Representative', ['cancelled'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Sales Representative', ['create'])): ?>
...
$(function () {
            ...
            { 
                ...
                render: function ( data, type, row ) {
                    ...
                    if (row.status == 'Inactive') {
                        if (isSADMIN || (permissions['Master Data'] && permissions['Master Data']['Sales Representative'] && permissions['Master Data']['Sales Representative'].includes('reactivate'))){
                            buttons += `
                        ...
                        if (isSADMIN || (permissions['Master Data'] && permissions['Master Data']['Sales Representative'] && ['edit', 'cancelled'].some(p => permissions['Master Data']['Sales Representative'].includes(p)))) {
                            buttons += `
                                <div class="dropdown d-inline-block">
                                    <button class="btn btn-soft-secondary btn-sm dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="ri-more-fill align-middle"></i>
                                    ...
                                    if (isSADMIN || (permissions['Master Data'] && permissions['Master Data']['Sales Representative'] && permissions['Master Data']['Sales Representative'].includes('edit'))){
                                        buttons += `
                                            <li>
                                    ...
                                    if (isSADMIN || (permissions['Master Data'] && permissions['Master Data']['Sales Representative'] && permissions['Master Data']['Sales Representative'].includes('cancelled'))){
                                        buttons += `
                                            <li>
    ...
    $('#exportExcel').on('click', function(){
        window.open("php/exportMasterData.php?selectedValue=Agent");
    });
