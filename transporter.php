...
<?php
    if (!hasModulePermission('Master Data', 'Transporter', ['view', 'create', 'edit'])){
        header('Location: no-permission.php');
        exit;
    }
?>
<head>
    <title>Transporter | PWS - Weighing System</title>
                                            ...
                                            <div class="modal-content">
                                                <form role="form" id="uploadForm">
                                                    ...
                                                    <div class="modal-footer justify-content-between bg-gray-dark color-palette">
                                                        ...
                                                        <button type="button" class="btn btn-danger" id="uploadTransporter">Save changes</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="card-header">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <div class="flex-shrink-0">
                                                                <?php if(hasModulePermission('Master Data', 'Transporter', ['download_template'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Transporter', ['upload_excel'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Transporter', ['export_excel'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Transporter', ['pull_from_sql'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Transporter', ['cancelled'])): ?>
                                                                ...
                                                                <?php if(hasModulePermission('Master Data', 'Transporter', ['create'])): ?>
...
$(function () {
            ...
            { 
                ...
                render: function ( data, type, row ) {
                    ...
                    if (row.status == 'Inactive') {
                        if (isSADMIN || (permissions['Master Data'] && permissions['Master Data']['Transporter'] && permissions['Master Data']['Transporter'].includes('reactivate'))){
                            buttons += `
                        ...
                        if (isSADMIN || (permissions['Master Data'] && permissions['Master Data']['Transporter'] && ['edit', 'cancelled'].some(p => permissions['Master Data']['Transporter'].includes(p)))) {
                            buttons += `
                                <div class="dropdown d-inline-block">
                                    <button class="btn btn-soft-secondary btn-sm dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="ri-more-fill align-middle"></i>
                                    ...
                                    if (isSADMIN || (permissions['Master Data'] && permissions['Master Data']['Transporter'] && permissions['Master Data']['Transporter'].includes('edit'))){
                                        buttons += `
                                            <li>
                                    ...
                                    if (isSADMIN || (permissions['Master Data'] && permissions['Master Data']['Transporter'] && permissions['Master Data']['Transporter'].includes('cancelled'))){
                                        buttons += `
                                            <li>
    ...
    $('#exportExcel').on('click', function(){
        window.open("php/exportMasterData.php?selectedValue=Transporter");
    });
