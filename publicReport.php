...
if (!hasModulePermission('Report', 'Public', ['view'])){
...
if (hasModulePermission('Report', 'Public', ['view_all_plants'])){
                                                    ...
                                                    <div class="col-3">
                                                        <div class="mb-3">
                                                            ...
                                                            <select id="plantSearch" class="form-select select2">
                                                                <?php if (hasModulePermission('Report', 'Public', ['view_all_plants'])){ ?>
                                                                <option selected>-</option>
                                                                <?php } ?>
                                                    ...
                                                    <div class="card-header">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <div class="flex-shrink-0">
                                                                <?php if (hasModulePermission('Report', 'Public', ['export_summary_report'])){ ?>
                                                                ...
                                                                <?php if (hasModulePermission('Report', 'Public', ['export_public_report'])){ ?>
                                                                ...
                                                                <?php if (hasModulePermission('Report', 'Public', ['export_excel'])){ ?>
