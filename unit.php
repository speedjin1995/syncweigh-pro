...
<head>
    <title>Units | Synctronix - Weighing System</title>
                                                    ...
                                                    <form role="form" id="unitForm" class="needs-validation" novalidate autocomplete="off">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="hstack gap-2 justify-content-end">
                                                                ...
                                                                <button type="button" class="btn btn-danger" id="submitUnit">Submit</button>
                                                            </div>
                                                        </div><!--end col-->                                                               
                                                    </form>
                                                </div>
                                            ...
                                            <div class="modal-content">
                                                <form role="form" id="uploadForm">
                                                    ...
                                                    <div class="modal-footer justify-content-between bg-gray-dark color-palette">
                                                        ...
                                                        <button type="button" class="btn btn-danger" id="uploadUnit">Save changes</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="card-header">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <div class="flex-shrink-0">
                                                                <a href="template/Unit_Template.xlsx" download>
                                                                ...
                                                                <button type="button" id="addUnit" class="btn btn-danger waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#addModal">
...
$(function () {
    ...
    $('#exportExcel').on('click', function(){
        window.open("php/exportMasterData.php?selectedValue=Unit");
    });
...
function reactivate(id) {
  if (confirm('Do you want to reactivate this item?')) {
    $('#spinnerLoading').show();
    $.post('php/reactivateMasterData.php', {userID: id, type: "Unit"}, function(data){
        var obj = JSON.parse(data);
