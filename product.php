                                                    ...
                                                    <form role="form" id="productForm" class="needs-validation" novalidate autocomplete="off">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="hstack gap-2 justify-content-end">
                                                                ...
                                                                <button type="button" class="btn btn-primary" style="background-color: #008001;" id="submitProduct">Submit</button>
                                                            </div>
                                                        </div><!--end col-->                                                               
                                                    </form>
                                                </div>
                                                    ...
                                                    <div class="card-header">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <div class="flex-shrink-0">
                                                                <button type="button" id="addProduct" style="background-color: #008001;" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#addModal">
