                                            ...
                                            <div class="modal-content">
                                                <form role="form" id="uploadForm">
                                                    ...
                                                    <div class="modal-footer justify-content-between bg-gray-dark color-palette">
                                                        ...
                                                        <button type="button" class="btn btn-danger" id="uploadSite">Save changes</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="card-header">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <div class="flex-shrink-0">
                                                                ...
                                                                <button type="button" id="addSite" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#addModal">
...
$(function () {
    ...
    $('#exportExcel').on('click', function(){
        window.open("php/exportMasterData.php?selectedValue=Site");
    });
    ...
    $('#multiDeactivate').on('click', function () {
        ...
        $("#siteTable tbody input[type='checkbox']").each(function () {
            if (this.checked) {
        ...
        if (selectedIds.length > 0) {
            if (confirm('Are you sure you want to cancel these items?')) {
                $.post('php/deleteSite.php', {userID: selectedIds, type: 'MULTI'}, function(data){
                    var obj = JSON.parse(data);
